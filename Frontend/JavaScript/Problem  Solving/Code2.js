//Program to find Maximum Element of an Array and Minimum Element of an Array
...
//Program to find the kth Maximum and Minimum Elment of the Array
...
/* Program to find the Unique Elements of the Array */
...
/* Progarm to find the Union of the Two Arrays */
...
//Program to find Maximum Occurance ELement in an Array
...
/* const arry = [1,1,2,3,2,5,5,6,7];

const duplicateElements = arry.filter((item, index) => arry.indexOf(item) !== index)
